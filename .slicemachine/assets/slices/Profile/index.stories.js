...
export const _Default = () => <MyComponent slice={{"variation":"default","version":"sktwi1xtmkfgx8626","items":[{}],"primary":{"title":[{"type":"heading1","text":"Frozen","spans":[]}],"description":[{"type":"paragraph","text":"Magna anim ad esse in ullamco magna laboris aliquip reprehenderit non.","spans":[]}]},"id":"_Default","slice_type":"profile"}} />
_Default.storyName = ''
...
export const _AwardCategories = () => <MyComponent slice={{"variation":"awardCategories","version":"sktwi1xtmkfgx8626","items":[{"title":"interest","sub_title":"weather"}],"primary":{"award":"die"},"id":"_AwardCategories","slice_type":"profile"}} />
